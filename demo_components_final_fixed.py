#!/usr/bin/env python3
"""
Linear 컴포넌트 데모 페이지 - 최종 완전 수정 버전
Linear 사이트 분석 후 완벽한 네비게이션 바 구현
"""
...
def create_perfect_navbar():
    """Linear 사이트 분석 후 완벽한 네비게이션 바 생성"""
    
    # Linear 사이트와 동일한 구조의 네비게이션 바
    navbar_html = f"""
    <div id="perfect-navbar" style="
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (navbar) {
            // 메뉴 링크 호버 효과
            const menuLinks = navbar.querySelectorAll('a[href^="#"]');
            ...
            // 버튼 호버 효과
            const buttons = navbar.querySelectorAll('a[href="#open-app"], a[href="#login"], a[href="#signup"]');
            buttons.forEach(button => {
                ...
                button.addEventListener('mouseleave', function() {
                    if (this.href.includes('#signup')) {
                        this.style.background = '#5e6ad2';
                        this.style.borderColor = '#5e6ad2';
                    } else if (this.href.includes('#open-app') || this.href.includes('#login')) {
                        this.style.background = 'transparent';
...
def create_perfect_hero():
    ...
    if hero_bg:
        hero_html = f"""
        <div style="
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('{hero_bg}');
        ...
        ">
            ...
            ">
                ...
                <p style="
                    ...
                    margin-left: auto;
                    margin-right: auto;
                ">MAIC 프로젝트를 위한 완전한 Linear 스타일 컴포넌트 라이브러리</p>
        ...
        ">
            ...
            ">
                <button style="
                    ...
                    cursor: pointer;
                    transition: all 0.2s ease;
                " onclick="alert('이전 슬라이드')">◀</button>
                <div style="flex: 1; text-align: center;">
                    <img src="{carousel_images[0]['image']}" style="
                        width: 100%;
                        max-width: 400px;
                        height: 200px;
                        object-fit: cover;
                    ...
                    <div style="
                        ...
                        color: #b0b0b0;
                        line-height: 1.5;
                    ">{carousel_images[0]['description']}</div>
                </div>
                <button style="
                    background: #5e6ad2;
                    border: none;
        ...
        <div style="margin: 2rem 0;">
            ...
            ">
                <div style="
                    ...
                    transition: all 0.2s ease;
                ">
                    <img src="{card_images[0]['image']}" style="
                        width: 100%;
                        height: 200px;
                        object-fit: cover;
                    " alt="Card 1">
                ...
                <div style="
                    ...
                    transition: all 0.2s ease;
                ">
                    <img src="{card_images[1]['image']}" style="
                        width: 100%;
                        height: 200px;
                        object-fit: cover;
                    " alt="Card 2">
                ...
                <div style="
                    ...
                    transition: all 0.2s ease;
                ">
                    <img src="{card_images[2]['image']}" style="
                        width: 100%;
                        height: 200px;
                        object-fit: cover;
                    " alt="Card 3">
