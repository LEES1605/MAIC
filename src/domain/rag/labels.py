...
- 표준 라벨: [문법서적], [이유문법], [AI지식]
- 별칭([문법책], [문법서] 등)은 canon_label()로 항상 [문법서적]으로 정규화한다.
"""
...
# 표준 라벨(SSOT): [문법서적] / [이유문법] / [AI지식]
BOOK_LABEL: Final = "[문법서적]"
...
_ALIASES: dict[str, str] = {
    "[문법서적]": BOOK_LABEL,  # 표준
    "[문법책]": BOOK_LABEL,    # 과거 표기
    "[문법서]": BOOK_LABEL,    # 축약/변형
    "[이유문법]": REASON_LABEL,
    "[AI지식]": AI_LABEL,
}
