# [02] START: FILE src/ui/admin_prompt.py — clean admin prompt (sider + release loader)
...
# ✅ 진짜 사이드바: 패키지 상대경로 우선, 실패 시 절대경로 폴백
try:
...
def main() -> None:
    ...
    with st.container(border=True):
        ...
        if p:
            ...
            st.warning("prompts.yaml을 release/assets 또는 루트에서 찾지 못했습니다.")
...
if __name__ == "__main__":
    main()
# [02] END: FILE src/ui/admin_prompt.py
